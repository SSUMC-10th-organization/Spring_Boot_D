package com.example.umc10thmission4.global.security.filter;
...
import com.example.umc10thmission4.global.security.service.CustomUserDetailsService;
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (jwtUtil.isValid(token)) {
                ...
                UserDetails member = customUserDetailsService.loadUserByUidAndSocialType(socialProvider, uid);
